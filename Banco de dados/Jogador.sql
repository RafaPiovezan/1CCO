...
select * from  clube , jogador  as jogador , jogador as conselheiro where jogador.fkConselheiro = conselheiro.idJogador  and jogador.fkClube = idTime ;
select * from  clube , jogador  as jogador , jogador as conselheiro where jogador.fkConselheiro = conselheiro.idJogador and jogador.nomeJogador = 'Danilo dos Santos' and jogador.fkClube = idTime;
